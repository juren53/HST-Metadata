...
# match the IPTC labels used below.  e.g Objectname, Headline, By-line, By-lineTitle, SpecialInstructions,
# Source, CopyRight, and Caption-Abstract, Credit.
# 
#
...
# Print a message
print("write-tags-from-csv.py ver 0.4  updated Sun 09 Jul 2023 11:12:06 AM CDT")
print(" ")
...
counter=0  # initializes counter for images processed reported at end of run
...
print("*** Missing files not processed:")
print(log)
