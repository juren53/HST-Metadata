...
1. The directory 'C:\Temp\Metadata-tagging' on the Scaning Workstation has been set aside as the working directory. Copy the the following required files to this directory:
