#!/usr/bin/env python3
"""  ===========================================================================
                          google-to-csv.py  v0.01
Google Sheets to Pandas DataFrame to export.csv file 
...
Usage:
    python google-to-csv.py [--sheet-url URL] [--export-csv [FILENAME]]

Options:
    --sheet-url, -u            URL of the Google Spreadsheet
    --export-csv, -e [FILENAME] Export data to CSV file (default: export.csv)

Created Thu 24 Apr 2025 01:42:39 AM CDT by compbing excel-to-csv.py with x3.py
=================================================================================
"""
