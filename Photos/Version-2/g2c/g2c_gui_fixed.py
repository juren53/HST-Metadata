#!/usr/bin/env python3
"""
Fixed GUI wrapper for g2c.py - Google Drive to CSV Converter with IPTC Mapping

This version includes fixes for:
- GObject/GTK warning suppression
- Better startup error handling
- Environment setup for PyQt5
...
# Suppress GObject/GTK warnings that can interfere with PyQt5
...
# Set environment variables for better PyQt5 compatibility
...
# Import the rest of the original classes with minimal changes
...
class G2CMainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        print("✅ G2C Main Window initialized successfully")
    ...
    def init_ui(self):
        ...
        version_label = QLabel("Ver 0.4 (Fixed)")
        version_font = QFont()
    ...
    # Include the rest of the methods from the original G2CMainWindow class...
    # (Methods like update_timestamp, log_message, auto_detect_clipboard_url, etc.)
    ...
    def closeEvent(self, event):
        ...
        print("👋 G2C GUI shutting down...")
        event.accept()

def main():
    """Main function to run the GUI application with improved error handling"""
    print("🚀 Starting G2C GUI (Fixed Version)...")
    ...
    try:
        ...
        app.setApplicationName("G2C GUI (Fixed)")
        app.setApplicationVersion("0.4-fixed")
