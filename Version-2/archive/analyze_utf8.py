...
Ver 0.4.1  - print version header and total count of special characters; keep Object Name in exceptions
"""
        ...
        if issues:
            ...
            for line_num, object_name, highlighted_line, suspicious_chars in issues:
                ...
                for pos, char, code in suspicious_chars:
                    out(f"  Position {pos}: '{char}' (Unicode: U+{code:04X}, Decimal: {code})")
                out("-" * 40)
        else:
